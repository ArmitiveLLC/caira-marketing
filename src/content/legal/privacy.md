...
- **Center directors and administrators** who manage accounts, staff, and center settings
- **Teachers and staff** who log activities, photos, and classroom notes
- **Parents and guardians** who receive updates and communicate with their child's center

If you use Caira through your childcare center, your center may also have policies that apply to how staff and families use the service.

## Information we collect

Depending on your role and how your center uses Caira, we may collect:

### Account and profile information

- Name, email address, phone number, and role (director, teacher, parent)
- Center affiliation, classroom assignments, and authentication credentials
- Profile preferences and notification settings

### Child-related information

Centers may enter information about enrolled children, such as:

- Child's first name and classroom
...
We do not sell personal information. We do not use child information for third-party advertising.
...
Our infrastructure uses Google Cloud and Firebase. Data is stored in the United States unless otherwise agreed in writing with your center.

## Data retention

We retain information while your center's account is active and as needed to provide the service, comply with law, resolve disputes, and enforce agreements. Centers may request deletion of certain data subject to legal and operational requirements. Contact us for retention questions.

## Security

We use administrative, technical, and organizational measures designed to protect information, including encryption in transit, access controls, and audit logging. No method of transmission or storage is completely secure; please use strong passwords and report suspected unauthorized access promptly.

## Children's privacy

Caira is designed for use by childcare centers, not for direct registration by children. Child information is entered and managed by centers and authorized staff. We process child information on behalf of centers to deliver the service. Centers should provide appropriate notices and obtain consents required under COPPA, FERPA, state childcare regulations, and their own policies.
...
Caira is primarily operated for U.S. childcare centers. If you access Caira from outside the United States, you understand that information may be processed in the United States.

## Changes to this policy

We may update this Privacy Policy from time to time. We will post the updated version on [caira.care/privacy](https://caira.care/privacy) and update the "Last updated" date. Material changes may be communicated through the app or by email where appropriate.

## Contact us

**Caira / Armitive**

Email: [support@caira.care](mailto:support@caira.care)

Website: [https://caira.care](https://caira.care)

For App Store and Google Play listings, this policy applies to the Caira mobile application (bundle ID `com.armitive.caira`).
